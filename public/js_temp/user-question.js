...
function set_table_format(idx){
    $.ajax({
        ...
        success: function(response){
            ...
            if(chartData != null){
                $("#responsive_table" + idx +" div:first").removeClass("container");
                $("table tbody td").css("font-size", chartData.table.bsize+'px');
                $("table tbody td").css("color", chartData.table.bfcolor);
                $(".table.table-bordered th").attr("style", "background:"+chartData.table.hbcolor + '!important;color:'+chartData.table.hfcolor + '!important;'+"font-size:"+ chartData.table.hsize+'px!important;');
                $("tbody tr:odd td").css("background-color", chartData.table.bocolor);
                $("tbody tr:even td").css("background-color", chartData.table.becolor);
                $("tbody tr:odd td:first-child").attr("style", "background:"+chartData.table.bocolor + '!important;color:'+chartData.table.bfcolor + '!important;'+"font-size:"+ chartData.table.hsize+'px!important;');
                $("tbody tr:even td:first-child").attr("style", "background:"+chartData.table.becolor + '!important;color:'+chartData.table.bfcolor + '!important;'+"font-size:"+ chartData.table.hsize+'px!important;');

                $("table").css("width",chartData.table.width+"%");
                $("table").css("height",chartData.table.height+"px");
...
function noTableAndChartDraw(content, idx,cidx){

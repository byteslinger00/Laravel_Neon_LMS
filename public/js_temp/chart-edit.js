...
var ChartEdit = function () {
    ...
    $("#tb-width").on('change',function(){
        $(".custom table").css({"width":$(this).val()+'%'});    
    })
    ...
    $("#chart-width").on('change',function(){
        myChart.canvas.parentNode.style.widtth = $(this).val() + 'px';
        myChart.update();
        return;
    });

    $("#chart-height").on('change',function(){
        myChart.canvas.parentNode.style.height = $(this).val() + 'px';
        myChart.update();
        return;
    });
